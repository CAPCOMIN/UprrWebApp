...
PROJECT_PATH = "E:\\大创推荐算法"
DATA_PATH = "E:\\大创推荐算法\\Courses-Recommendation-system-master\\data\\features_sample.csv"
...
print("\n Please enter the number of recommendations you want. Enter a number between {} - {}".format(1, temp[
    'courseID'].unique().shape[0]))
